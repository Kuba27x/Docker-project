...
import { fuelTypes, fuelTypesValue, provinces } from "../data/data";
...
const CarForm = () => {
	...
	const steps = [
		{
			...
			description: "Wprowadź podstawowe informacje o pojeździe"
		},
		{
			label: "Lokalizacja",
			icon: <LocationOnIcon />,
			description: "Podaj lokalizację pojazdu"
		},
		{
			label: "Cena i podsumowanie",
			icon: <AttachMoneyIcon />,
			description: "Ustal cenę i sprawdź wprowadzone dane"
		}
	];
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (error.response && error.response.data) {
				...
				setSubmitError("Wystąpił błąd podczas dodawania samochodu");
			}
		}
	};
	...
	return (
		<>
			...
			<DataCard title='Formularz dodawania samochodu'>
				<Box sx={{ p: 3 }}>
					{submitError && (
					...
					{submitSuccess && (
						<Alert severity='success' sx={{ mb: 3 }}>
							Samochód został pomyślnie dodany! Przekierowywanie do listy
							samochodów...
						</Alert>
					)}
